 ...
 * 
 * STRUCTURE:
 * 1. Overlay - Dark backdrop covering the screen
 * 2. Drawer Panel - Slides in from right with three sections:
 *    a. Header Section (px-6 py-4)
 *       - Title on left
 *       - Close button (X) on right
 *       - Border bottom
 *    b. Content Section (px-6 py-4, scrollable)
 *       - Filter rows with "Where" and "What" dropdowns
 *       - "Add Filter" button
 *       - Empty state message when no filters
 *    c. Footer Section (px-6 py-4)
  ...
  return (
    <>
      ...
      >
        ...
        {/* ==================== CONTENT ==================== */}
        <div className="px-6 py-4 max-h-[calc(100%-120px)] overflow-y-auto">
